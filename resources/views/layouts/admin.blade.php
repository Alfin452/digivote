...
<body class="bg-slate-950 text-slate-300 font-sans flex h-screen overflow-hidden selection:bg-purple-500/30">
    ...
    <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col hidden md:flex">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="{{ route('admin.transactions.index') }}" class="flex items-center px-3 py-2.5 text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 font-medium rounded-lg transition-colors mt-1">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.settings.index') }}" class="flex items-center px-3 py-2.5 text-slate-400 hover:bg-slate-800/50 hover:text-slate-200 font-medium rounded-lg transition-colors mt-1">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

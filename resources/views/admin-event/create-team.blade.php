...
<div class="bg-slate-900 rounded-2xl shadow-sm border border-slate-800 overflow-hidden w-full relative">
    ...
    <div class="p-6 md:p-8 relative z-10">
        ...
        <form action="{{ route('admin-event.team.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-end pt-6 border-t border-slate-800">
                <button type="submit" class="inline-flex items-center bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)] hover:shadow-[0_0_25px_rgba(6,182,212,0.5)] transform hover:-translate-y-0.5">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

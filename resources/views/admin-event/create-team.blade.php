...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-extrabold text-gray-900">Tambah Peserta / Kandidat</h1>
    <p class="text-gray-500 mt-1">Masukkan data lengkap peserta. Foto bersifat opsional.</p>
</div>
        ...
        <form action="{{ route('admin-event.team.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="number" id="number" value="{{ old('number') }}" required placeholder="Contoh: 01" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all">
                </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Masukkan nama" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all">
            </div>

            <div class="mb-6">
                <label for="location" class="block text-sm font-bold text-gray-700 mb-2">Asal / Instansi / Lokasi</label>
                <input type="text" name="location" id="location" value="{{ old('location') }}" placeholder="Contoh: Fakultas Teknik / SMAN 1" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all">
            </div>

            <div class="mb-8">
                <label for="image" class="block text-sm font-bold text-gray-700 mb-2">Foto / Logo (Opsional)</label>

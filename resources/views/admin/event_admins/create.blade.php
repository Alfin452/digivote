...
<div class="w-full pb-10">
    ...
    <form action="{{ route('admin.event-admins.store') }}" method="POST" autocomplete="off" class="space-y-6">
        @csrf

        {{-- KARTU 1: Penugasan & Identitas (Tanpa overflow-hidden) --}}
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80">
            <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                ...
                <p class="text-sm text-slate-500">Tentukan nama panitia dan event yang akan dikelola.</p>
            </div>
        ...
        {{-- KARTU 2: Akses Kredensial --}}
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80">
            <div class="px-6 py-5 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                <h3 class="text-lg font-heading font-bold text-slate-800">2. Akses Login</h3>
                <p class="text-sm text-slate-500">Kredensial yang akan digunakan panitia untuk masuk ke panel mereka.</p>
            </div>
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Input Password dengan Toggle Alpine.js (Di Create, Password Wajib/Required) --}}
...
{{-- Style custom scrollbar untuk list dropdown --}}
<style>
